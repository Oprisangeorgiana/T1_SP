...
t=0:0.002:5;         % un vector prntru timp care merge de la 0 la 5 secunde, cu pasul de 2 ms
...
title('Semnal triunghiular cu rezolutia temporara de 2 ms'); %titlul figurii
